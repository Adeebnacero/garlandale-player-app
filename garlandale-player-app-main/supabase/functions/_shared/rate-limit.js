// Shared rate-limiting helper - lives in supabase/functions/_shared/ and is
// imported by every Edge Function via a relative path (e.g.
// `../_shared/rate-limit.js`), rather than being copy-pasted into each
// function's own folder. The Supabase CLI bundles relative imports from
// anywhere under supabase/functions/ at deploy time, so this works across
// separate function deploys without needing a build step.
//
